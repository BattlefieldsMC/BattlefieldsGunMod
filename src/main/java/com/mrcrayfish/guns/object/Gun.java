...
public final class Gun implements INBTSerializable<CompoundNBT>
{
    ...
    public static class Projectile implements INBTSerializable<CompoundNBT>
    {
        ...
        @Optional
        private boolean spawnBulletHole = true;
    ...
    {
        return gunStack.getTag() == null ? 0.0f : gunStack.getTag().getFloat("AdditionalDamage");
    }
    ...
    {
        return gunStack.getTag() != null && (gunStack.getTag().getBoolean("IgnoreAmmo") || gunStack.getTag().getInt("AmmoCount") > 0);
    }
}
